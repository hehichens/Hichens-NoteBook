...
- `形容词`作定语
  ...
  > The innocent nightingable(夜莺) died.

  > That nightingable (brave and innocent) died.

- `名词（短语）`作定语

  > The nightingable's singing can mke the rose bloom.:x:

  > The singing (of the nightingable) can make the rose bloom.

- `介词短语`作定语

  > The nightingbale (out of the window) heard the sighs of th youngster.
...
> This is a fiction(story) about a nightingable and a rose.
...
- 充当主语或宾语的成分：`who, whom, that, which`
...
> The rose <u>that</u> (the nightingable exchanged with his life ) was discarded.
>
> exchanged 后面缺宾语
...
> Students who fail to concentrte in class but wish to pass examinations smoothly tend to find <u>that</u> the consequence proves less impressive(bad).
...
- `that`做引导词的省略
  ...
  > I enjoy the book <u>that</u> my mother bought for me.
